...
export const profile: Profile = {
  ...
  description: `기본이 탄탄한 시맨틱 마크업과 웹 접근성을 바탕으로, 최근에는 React를 활용한 컴포넌트 기반 설계와 UI 성능 최적화에 몰입하고 있습니다.\n단순히 시안을 화면으로 옮기는 것을 넘어, 유지보수하기 좋은 코드로 구조를 다듬고 사용자 경험을 매끄럽게 연결하는 과정에서 가장 즐거움을 느낍니다.`,
